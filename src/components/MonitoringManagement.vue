<template>
  ...
  >
    <template v-slot:top>
      <v-toolbar flat>
        ...
        <v-dialog v-model="dialogViewData" persistant max-width="700px">
          <v-card>
            <v-card-title>
              <span class="headline"> All Data </span>
            </v-card-title>
            <v-card-text>
              <v-container>
                <v-row>
                  <v-col cols="12">
                    <v-text-field
                      label="Monitoring Id"
                      v-model="allData.viewMonitoringId"
                      required
                    >
                    </v-text-field>
                  </v-col>
                  ...
                  <v-col cols="12">
                    <v-text-field
                      ...
                      v-model="allData.viewRunningCommand"
                      required
                    >
                    </v-text-field>
                  </v-col>
                  ...
                  <v-col cols="12">
                    <v-text-field
                      label="Last Update"
                      v-model="allData.viewLastUpdate"
                      required
                    >
                    </v-text-field>
                  </v-col>
                  ...
                  <v-col cols="12">
                    <v-text-field
                      label="Haproxy Port"
                      v-model="allData.viewHaproxy_port"
                      required
                    >
                    </v-text-field>
                  </v-col>
            ...
            <v-card-actions>
              <v-btn color="blue-draken-1" text @click="dialogViewData = false"
                >Back</v-btn
              >
            </v-card-actions>
          </v-card>
        ...
        <v-dialog v-model="dialogEdit" persistant max-width="700px">
          <v-card>
            <v-card-title>
              <span class="headline"> Update Data </span>
            </v-card-title>
                ...
                <v-form ref="form" v-model="valid">
                  <v-row>
                    <v-col cols="4">
                      <v-text-field
                        label="Username"
                        v-model="monitoringEdit.editUsername"
                        required
                      >
                      </v-text-field>
                    </v-col>
                    <v-col cols="4">
                      <v-text-field
                        label="Name"
                        v-model="monitoringEdit.editName"
                        required
                      >
                      </v-text-field>
                    </v-col>
                    <v-col cols="4">
                      <v-text-field
                        label="Path"
                        v-model="monitoringEdit.editPath"
                        required
                      >
                      </v-text-field>
                    </v-col>
                    ...
                    <v-col cols="4">
                      <v-text-field
                        label="Port"
                        v-model="monitoringEdit.editPort"
                        required
                      >
                      </v-text-field>
                    </v-col>
                    ...
                    <v-col cols="4">
                      <v-text-field
                        label="Running Command"
                        v-model="monitoringEdit.editRunningCommand"
                        required
                      >
                      </v-text-field>
                    </v-col>
                    <v-col cols="4">
                      <v-text-field
                        label="Running On"
                        v-model="monitoringEdit.editRunningOn"
                        required
                      >
                      </v-text-field>
                    </v-col>
                    <v-col cols="4">
                      <v-text-field
                        label="Last Update"
                        v-model="monitoringEdit.editLastUpdate"
                        required
                      >
                      </v-text-field>
                    </v-col>
                    <v-col cols="4">
                      <v-text-field
                        label="Git Url"
                        v-model="monitoringEdit.editGitUrl"
                        required
                      >
                      </v-text-field>
                    </v-col>
                    <v-col cols="4">
                      <v-text-field
                        label="Haproxy Ip"
                        v-model="monitoringEdit.editHaproxy"
                        required
                      >
                      </v-text-field>
                    </v-col>
                    <v-col cols="4">
                      <v-text-field
                        label="Haproxy Port"
                        v-model="monitoringEdit.editHaproxyPort"
                        required
                      >
                      </v-text-field>
                    </v-col>
            ...
            <v-card-actions>
              <v-btn color="blue-draken-1" text @click="closeDialogEdit"
                >Batal</v-btn
              >
              <v-btn color="blue-draken-1" text @click="updateMonitoring"
                >Tambah</v-btn
              >
            </v-card-actions>
          </v-card>
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="blue-draken-1" text @click="closeDialogDelete"
                >Batal</v-btn
              >
              <v-btn color="blue-draken-1" text @click="deleteMonitoring()"
                >Delete</v-btn
              >
              <v-spacer></v-spacer>
            </v-card-actions>
    ...
    <template v-slot:item.actions="{ item }">
      <v-icon small class="mr-2" @click.stop="editMonitoring(item)">
        mdi-pencil
      </v-icon>
      <v-icon small @click.stop="getDelete(item)"> mdi-delete </v-icon>
    </template>
  </v-data-table>
</template>
...
export default {
  ...
  computed: {
    ...
    resultData() {
      if (this.search) {
        return this.monitoringData.filter((i) =>
  ...
  methods: {
    ...
    createMonitoring() {
      axios
        .post("http://localhost:8080/monitoring/save-monitoring", {
          git_url: this.gitUrl,
    ...
    updateMonitoring() {
      axios
        .put("http://localhost:8080/monitoring/update-monitoring", {
    ...
    deleteMonitoring() {
      ...
      axios
        .delete(`http://localhost:8080/monitoring/delete-monitoring/${id}`, {
          data: {
