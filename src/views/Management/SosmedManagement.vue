      ...
      <v-container fluid>
        ...
        >
                      ...
                      <v-form ref="form" v-model="valid">
                        <v-row>
                          ...
                          <v-col cols="3">
                            ...
                            >
                              <template v-slot:item="items">
                                <i
                                  :class="['mr-2', 'mdi', items.item.flag]"
                                ></i>
                                {{ items.item.name }}
                              </template>
                            </v-select>
                          ...
                          <v-col cols="3">
                            <v-text-field
                              label="Description"
                              v-model="getSosmed.description"
                            >
                            </v-text-field>
                          </v-col>
                          <v-col cols="3">
                            <v-text-field
                              v-if="getSosmed.select == `Twitter`"
                              label="Consumer Key false"
                ...
                <v-card>
                      ...
                      <v-row>
                        <v-col cols="3">
                          <v-text-field
                            ...
                            :rules="[rules.required]"
                            label="Username"
                            v-model="editSosmed.editUsername"
                            required
                          >
                          </v-text-field>
                        </v-col>
                        <v-col cols="3">
                          <v-text-field
                            :rules="[rules.required]"
                            label="Screen Name"
                            v-model="editSosmed.editScreenName"
                            required
                          >
                          </v-text-field>
                        </v-col>
                        ...
                        <v-col cols="3">
                          <v-text-field
                            label="Phone No"
                            v-model="editSosmed.editPhoneNo"
                            :rules="[rules.required]"
                          >
                          </v-text-field>
                        </v-col>
                        <v-col cols="3">
                          <v-text-field
                            label="Password"
                            v-model="editSosmed.editPassword"
                            :rules="[rules.required]"
                          >
                          </v-text-field>
                        </v-col>
                        ...
                        <v-col cols="3">
                          <v-text-field
                            label="App Name"
                            v-model="editSosmed.editAppName"
                            :rules="[rules.required]"
                          >
                          </v-text-field>
                        </v-col>
                        ...
                        <v-col cols="3">
                          <v-text-field
                            label="Description"
                            v-model="editSosmed.editDescription"
                          >
                          </v-text-field>
                        </v-col>
                        <v-col cols="3">
                  ...
                  <v-card-actions>
                    ...
                    <v-btn
                      ...
                      >Cancel</v-btn
                    >
                    <v-btn color="blue-draken-1" text @click="updateSosmed"
                      >Edit</v-btn
                    >
                  </v-card-actions>
                </v-card>
                ...
                <v-card>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn
                      ...
                      >Batal</v-btn
                    >
                    <v-btn color="blue-draken-1" text @click="deleteSosmed()"
                      >Delete</v-btn
                    >
                    <v-spacer></v-spacer>
                  </v-card-actions>
          ...
          <template v-slot:item.actions="{ item }">
            <v-icon small class="mr-2" @click="getEditSosmed(item)">
              mdi-pencil
            </v-icon>
...
export default {
  ...
  data: () => ({
    ...
    dataStatus: ["Active", "Available", "Not Active", "Blocked"],
    permissions: [
      {
        name: "Facebook",
        flag: "mdi-facebook",
  ...
  methods: {
    ...
    getEditSosmed(dataSosmed) {
      ...
      this.editSosmed.editId = dataSosmed.id;
      ...
      this.editSosmed.editType = dataSosmed.type;
    },
    updateSosmed() {
      axios
        .put("http://localhost:8080/account/update-account", {
          id: this.editSosmed.editId,
