          ...
          <template v-slot:top>
            <v-toolbar flat>
              <v-toolbar-title class="mr-15"
                >Project Monitoring</v-toolbar-title
              >
                ...
                <v-card>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn
                      ...
                      >Add</v-btn
                    >
                    <v-btn color="blue-draken-1" text @click="deleteProject()"
                      >Delete</v-btn
                    >
                    <v-spacer></v-spacer>
                  </v-card-actions>
...
export default {
  ...
  data: () => ({
    ...
    Text2: [(v) => !!v || "Project Name is required"],
    Text3: [(v) => !!v || "Keterangan is required"],
    Text4: [(v) => !!v || "Username is required"],
  ...
  computed: {
    resultData() {
      if (this.search) {
        return this.dataProject.filter((i) =>
          i.project_name.toLowerCase().includes(this.search.toLowerCase())
        );
      } else {
  ...
  methods: {
    ...
    createProject() {
      axios
        .post("http://localhost:8080/project/save-project", {
    ...
    updateProject() {
      axios
        .put("http://localhost:8080/project/update-project", {
    ...
    deleteProject() {
      ...
      axios
        .delete(`http://localhost:8080/project/delete-project/${id}`, {
          data: {
